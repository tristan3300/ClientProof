...
export const metadata: Metadata = {
  title: {
    default:
      "ClientProof - Analysez un prospect avant de signer. Évitez les mauvais contrats.",
  ...
  return (
    <html lang="fr">
      <head>
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-S7TZ68YMJ2"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1956910848230901&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </head>
